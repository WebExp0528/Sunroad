...
<html lang="en">
    ...
    <body <?php if(Setting::get('enable_rtl') == 'on'): ?> class="direction-rtl" <?php endif; ?> style="background-image:url(<?php echo Theme::asset()->url('registration/images/background/1.jpg'); ?>)">
        <div class="">
