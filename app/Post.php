...
class Post extends Model
{
   ...
   * @var array
   */
    protected $fillable = ['content', 'title', 'timeline_id', 'description', 'user_id','type', 'youtubeURL', 'photoURL', 'photo_width','photo_height', 'bandcamURL', 'hide', 'audioURL', 'shared_post_id'];
